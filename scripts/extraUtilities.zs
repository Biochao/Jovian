...
// Node Tweaks
recipes.addShaped(<ExtraUtilities:extractor_base:6> * 8, [[null, <ExtraUtilities:pipes:*>, null], [<ore:dustRedstone>, <minecraft:ender_eye>, <ore:dustRedstone>], [<ore:ingotIron>, <minecraft:bucket>, <ore:ingotIron>]]);
recipes.addShaped(<ExtraUtilities:extractor_base> * 8, [[null, <ExtraUtilities:pipes>, null], [<ore:dustRedstone>, <minecraft:ender_eye>, <ore:dustRedstone>], [<ore:stone>, <ore:chestWood>, <ore:stone>]]);
...
// Recipe for Restoring soul
recipes.addShaped(<ExtraUtilities:mini-soul:3>, [[<minecraft:skull:3>], [<minecraft:nether_star>], [<TConstruct:heartCanister:3>]]);
